...
$ImageGenRoot = Join-Path $CodexServerRoot "image-gen"

New-Item -ItemType Directory -Force -Path $BinDir, $SkillsDir, $PluginRoot, $ImageGenRoot, (Split-Path -Parent $MarketplaceFile) | Out-Null
